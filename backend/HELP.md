...
* The original package name 'com.example.book-management' is invalid and this project uses 'com.example.book_management' instead.
...
* [Spring for GraphQL](https://docs.spring.io/spring-boot/docs/3.2.6/reference/htmlsingle/index.html#web.graphql)
